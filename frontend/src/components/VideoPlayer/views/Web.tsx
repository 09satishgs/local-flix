    ...
    >
      ...
      <Box
        sx={{
          ...
          background: 'linear-gradient(to bottom, rgba(0,0,0,0.7) 0%, rgba(0,0,0,0) 20%, rgba(0,0,0,0) 80%, rgba(0,0,0,0.8) 100%)',
      ...
      >
        ...
        <Box sx={{ p: 3, display: 'flex', alignItems: 'center' }}>
          <IconButton
            onClick={onClose}
            sx={{ color: '#fff', mr: 2, '&:hover': { color: 'var(--localflix-red)' } }}
          >
            ...
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
              ...
              <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, mr: 2 }}>
                <IconButton onClick={toggleMute} sx={{ color: '#fff' }}>
                  {isMuted ? <VolumeOff /> : volume > 0.5 ? <VolumeUp /> : volume > 0 ? <VolumeDown /> : <VolumeMute />}
                </IconButton>
                <Slider
                  ...
                  >
                    ...
                    {subtitles.map((track) => (
                      <MenuItem
                        ...
                        sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: 2, minWidth: 220 }}
                      >
                        ...
                        <IconButton
                          ...
                          sx={{ color: 'var(--text-secondary)', '&:hover': { color: '#fff' }, p: 0.5 }}
                        ...
                        <Box sx={{ px: 2, py: 1, display: 'flex', flexDirection: 'column', gap: 1 }}>
                          ...
                          <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5, justifyContent: 'space-between' }}>
                            <Button
                              ...
                              sx={{ minWidth: 32, p: 0.5, border: '1px solid #333', color: '#fff', '&:hover': { border: '1px solid #555' } }}
                            >
                              -0.5s
                            </Button>
                            <Typography variant="body2" sx={{ fontWeight: 600, minWidth: 60, textAlign: 'center' }}>
