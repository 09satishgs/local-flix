...
I have a mini PC — an Intel 12th Gen i5-12500H with 32 GB DDR5, a 1 TB NVMe SSD, 2.5 Gb LAN, and Wi-Fi 6 — lying around doing nothing. At the same time, our home has *way too many pen drives*: some for movies, some for web series and TV shows, and others for anime. Everyone watches from more than one drive, so there's a constant headache of figuring out who wants to watch what and which pen drive has it.

The fix was obvious: dump everything onto the mini PC and host it over Wi-Fi. Create a profile for each family member, give them access to only the shows they actually watch, and let everyone have their own watch history and resume capability — no more arguing over pen drives.
