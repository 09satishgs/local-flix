...
- See [ARCHITECTURE.md](./ARCHITECTURE.md) for details on components, data structures, and the FFmpeg pipeline.
- See [API.md](./API.md) for the complete HTTP JSON REST API reference.
...
npm start
# → Server runs on port 4000 (0.0.0.0:4000)
```
